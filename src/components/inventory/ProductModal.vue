  ...
  <Teleport to="body">
    <Transition enter-active-class="transition-opacity duration-300" enter-from-class="opacity-0"
      ...
      <div v-if="show" class="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4"
        ...
        <Transition enter-active-class="transition-all duration-300" enter-from-class="scale-95 opacity-0"
          enter-to-class="scale-100 opacity-100" leave-active-class="transition-all duration-200"
          leave-from-class="scale-100 opacity-100" leave-to-class="scale-95 opacity-0">
          <div v-if="show" class="bg-white rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto"
            @click.stop>
              ...
              <form @submit.prevent="handleSubmit" class="space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input id="code" v-model="form.code" type="text" placeholder="Ej: COMP001"
                  ...
                  <div>
                    ...
                    <input id="sku" v-model="form.sku" type="text" placeholder="Ej: SKU001"
                      class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
                ...
                <div>
                  ...
                  <input id="name" v-model="form.name" type="text" required placeholder="Ej: Laptop Dell Inspiron"
                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
                ...
                <div>
                  ...
                  <textarea id="description" v-model="form.description" rows="3"
                    ...
                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors resize-none"></textarea>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input id="minStock" v-model.number="form.minStock" type="number" min="0" placeholder="5"
                      class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors" />
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <div class="relative">
                      <span class="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500">$</span>
                      <input id="cost" v-model.number="form.cost" type="number" min="0" step="0.01" placeholder="0.00"
                        class="w-full pl-8 pr-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
                ...
                <div v-if="generalError"
                  class="bg-red-50 border-2 border-red-200 rounded-lg p-4 flex items-start gap-3">
                ...
                <div class="flex flex-col sm:flex-row gap-3">
                  ...
                  <button type="submit" :disabled="saving"
                    ...
                    <svg v-if="saving" class="w-5 h-5 animate-spin" viewBox="0 0 24 24" fill="currentColor">
                      <path d="M12,1A11,11 0 1 0 23,12A11,11 0 0 0 12,1Zm0,19a8,8 0 1 1 8-8A8,8 0 0 1 12,20Z"
                        opacity=".25" />
                      <path

  ...
  <aside
      ...
      <ul class="space-y-2 px-3">
        ...
        <li v-if="canManageProducts">
          <router-link to="/inventory"
            ...
            <svg class="w-6 h-6 flex-shrink-0" viewBox="0 0 24 24" fill="currentColor">
              <path
                d="M19,20H4C2.89,20 2,19.1 2,18V6C2,4.89 2.89,4 4,4H10L12,6H19A2,2 0,1 21,8H21L4,8V18L6.14,10H23.21L20.93,18.5C20.7,19.37 19.92,20 19,20Z" />
            </svg>
        ...
        <li v-if="canManageProducts">
          <router-link to="/cyclic-count"
            ...
            <svg class="w-6 h-6 flex-shrink-0" viewBox="0 0 24 24" fill="currentColor">
              <path
                d="M4,4H7L9,2H15L17,4H20A2,2 0,1 22,6V18A2,2 0,1 20,20H4A2,2 0,1 2,18V6A2,2 0,1 4,4M12,7A5,5 0,0 7,12A5,5 0,0 12,17A5,5 0,0 17,12A5,5 0,0 12,7M12,9A3,3 0,1 15,12A3,3 0,1 12,15A3,3 0,1 9,12A3,3 0,1 12,9Z" />
            </svg>
        ...
        <li v-if="canViewDashboard">
          <router-link to="/movements"
            ...
            <svg class="w-6 h-6 flex-shrink-0" viewBox="0 0 24 24" fill="currentColor">
              <path
                d="M13.5,8H12V13L16.28,15.54L17,14.33L13.5,12.25V8M13,3A9,9 0,0 4,12H1L4.96,16.03L9,12H6A7,7 0,1 13,5A7,7 0,1 20,12A7,7 0,1 13,19C11.07,19 9.32,18.21 8.06,16.94L6.64,18.36C8.27,20 10.5,21 13,21A9,9 0,0 22,12A9,9 0,0 13,3" />
            </svg>
    ...
    <div class="p-5 border-t border-white/10 space-y-3">
      <div v-show="!isCollapsed || isMobile" class="space-y-2">
        ...
        <div v-if="projectCode" class="flex items-center gap-2">
          <span
            ...
            <button 
              ...
              class="hover:bg-indigo-200 p-0.5 rounded transition-colors"
              title="Copiar código">
    ...
    <Toast
      ...
      message="El código del proyecto se copió al portapapeles"
      :duration="2000"

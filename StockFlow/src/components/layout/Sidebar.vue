<template>
  <aside class="sidebar bg-gradient-to-br from-blue-500 to-blue-600 text-white flex flex-col transition-all duration-300 relative shadow-lg" 
      ...
      <ul class="list-none p-0 m-0">
        <li class="mb-1">
          ...
          >
            ...
            <span v-show="!isCollapsed" class="font-medium whitespace-nowrap transition-opacity duration-300">Dashboard</span>
            
            <!-- Tooltip para sidebar colapsado -->
            <div v-if="isCollapsed" class="absolute left-full ml-2 px-2 py-1 bg-gray-900 text-white text-sm rounded opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-50 whitespace-nowrap">
              Dashboard
            </div>
          </router-link>
        </li>
        ...
        <li class="mb-1">
          ...
          >
            ...
            <span v-show="!isCollapsed" class="font-medium whitespace-nowrap transition-opacity duration-300">Inventario</span>
        ...
        <li class="mb-1">
          ...
          >
            ...
            <span v-show="!isCollapsed" class="font-medium whitespace-nowrap transition-opacity duration-300">Productos</span>
        ...
        <li class="mb-1">
          ...
          >
            ...
            <span v-show="!isCollapsed" class="font-medium whitespace-nowrap transition-opacity duration-300">Reportes</span>
        ...
        <li class="mb-1">
          ...
          >
            ...
            <span v-show="!isCollapsed" class="font-medium whitespace-nowrap transition-opacity duration-300">Configuración</span>
    ...
    <div class="p-5 border-t border-white/10">
      <div class="flex items-center gap-3">
        ...
        <div v-show="!isCollapsed" class="overflow-hidden transition-opacity duration-300">
...
// Inject TANTO el estado como la función desde DashboardLayout
const isCollapsed = inject('sidebarCollapsed', ref(false))
const toggleSidebar = inject('toggleSidebar', () => {
  console.warn('toggleSidebar not provided')
})

// Función local que usa la función inyectada
const handleToggle = () => {
  console.log('Button clicked in Sidebar') // Para debug
  toggleSidebar()
}
...
<style scoped>
/* CSS custom solo para el colapso - Tailwind para el resto */
.sidebar {
  width: 280px;
  min-height: 100vh;
